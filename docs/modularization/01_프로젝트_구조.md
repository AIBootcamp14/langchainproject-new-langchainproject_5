...
graph TB
    ...
    %% 노드 스타일 (입력 - 청록 계열)
    style Start fill:#66bb6a,stroke:#2e7d32,stroke-width:3px,color:#fff
    style User fill:#80deea,stroke:#00838f,color:#000
    ...
    style Text2SQLTool fill:#ce93d8,stroke:#7b1fa2,color:#000
    ...
    style PostgreSQL2 fill:#a5d6a7,stroke:#388e3c,color:#000
    ...
    %% 노드 스타일 (답변 표시 - 빨강 계열)
    style DispStart fill:#ffcdd2,stroke:#c62828,color:#000
    style ShowAnswer fill:#ef9a9a,stroke:#c62828,color:#000
    style SaveTerms fill:#e57373,stroke:#c62828,color:#000

    %% 노드 스타일 (품질 평가 - 파랑 계열)
    style EvalStart fill:#bbdefb,stroke:#1565c0,color:#000
    style EvalAnswer fill:#90caf9,stroke:#1565c0,color:#000
    style SaveEval fill:#64b5f6,stroke:#1565c0,color:#000
    style ShowEval fill:#42a5f5,stroke:#1565c0,color:#000

    %% 노드 스타일 (흐름 제어)
    style Continue fill:#ba68c8,stroke:#7b1fa2,color:#fff
    style End fill:#a5d6a7,stroke:#388e3c,color:#000
```
