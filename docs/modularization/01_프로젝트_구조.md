...
graph TB
    ...
    %% 노드 스타일 (설정 - 투명 유지)
    style DBConfig fill:#fff,stroke:#f57c00,stroke-width:2px,color:#000
    style ModelConfig fill:#fff,stroke:#f57c00,stroke-width:2px,color:#000
    style MultiRequest fill:#fff,stroke:#f57c00,stroke-width:2px,color:#000
    style PromptConfig fill:#fff,stroke:#f57c00,stroke-width:2px,color:#000
    style CollectConfig fill:#fff,stroke:#f57c00,stroke-width:2px,color:#000
    ...
    style RoutingPrompts fill:#fff,stroke:#01579b,stroke-width:2px,color:#000
    style ToolPrompts fill:#fff,stroke:#01579b,stroke-width:2px,color:#000
    style EvalPrompts fill:#fff,stroke:#01579b,stroke-width:2px,color:#000
    style QGenPrompts fill:#fff,stroke:#01579b,stroke-width:2px,color:#000
    style GoldenDataset fill:#fff,stroke:#01579b,stroke-width:2px,color:#000
