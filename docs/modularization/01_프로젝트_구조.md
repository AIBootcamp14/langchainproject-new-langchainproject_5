...
graph TB
    ...
    %% 연결선 스타일 (Configs 내부 2~5 - 투명)
    linkStyle 2,3,4,5 stroke:#none,stroke-width:0px

    %% 연결선 스타일 (Source 핵심로직 6~7 - 주황)
    linkStyle 6,7 stroke:#f57c00,stroke-width:2px

    %% 연결선 스타일 (Source 데이터처리 8~9 - 주황)
    linkStyle 8,9 stroke:#f57c00,stroke-width:2px

    %% 연결선 스타일 (Source 인프라 10~11 - 주황)
    linkStyle 10,11 stroke:#f57c00,stroke-width:2px

    %% 연결선 스타일 (Source 지원기능 12~13 - 주황)
    linkStyle 12,13 stroke:#f57c00,stroke-width:2px

    %% 연결선 스타일 (Source 서브그룹 간 14~16 - 회색)
    linkStyle 14,15,16 stroke:#616161,stroke-width:3px

    %% 연결선 스타일 (Prompts 내부 17~20 - 투명)
    linkStyle 17,18,19,20 stroke:#none,stroke-width:0px

    %% 연결선 스타일 (UI 내부 21~22 - 하늘색)
    linkStyle 21,22 stroke:#0288d1,stroke-width:2px

    %% 연결선 스타일 (Scripts 내부 23~24 - 빨강)
    linkStyle 23,24 stroke:#c62828,stroke-width:2px
    ...
    %% 연결선 스타일 (메인 그룹 간 연결 33~39 - 회색)
    linkStyle 33,34,35,36,37,38,39 stroke:#616161,stroke-width:3px
```
