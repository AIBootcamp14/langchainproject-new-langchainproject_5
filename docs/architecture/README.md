...
6. [문서 읽는 방법](#문서-읽는-방법)
7. [이해를 돕기 위한 학습 순서](#이해를 -돕기-위한-학습-순서)
8. [핵심 문서 추천](#핵심-문서-추천)
...
이 폴더는 **논문 리뷰 챗봇 AI Agent 시스템의 상세 아키텍처 문서**를 담고 있습니다. 쉽게 이해할 수 있도록 각 기능의 동작 방식, 데이터 흐름, 도구 간 연계를 상세히 설명합니다.

### 문서 작성 원칙

1. **문서 작성 규칙**: 기술 용어를 최소화하고, 그림(Mermaid 다이어그램)을 적극 활용하여 시각적으로 설명합니다.
...
1. 이 README를 먼저 읽습니다.
2. "이해를 돕기 위한 학습 순서"를 따라 단계적으로 문서를 읽습니다.
