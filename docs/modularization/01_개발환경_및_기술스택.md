...
- **LLM**: OpenAI (GPT-4/GPT-3.5), Solar (solar-pro) 듀얼 LLM 시스템
...
| **LLM** | OpenAI GPT-4 | Latest | 높은 성능, 안정적 Function Calling | 상용 |
| | OpenAI GPT-3.5-turbo | Latest | 빠른 응답, 비용 효율적 | 상용 |
...
1. **OpenAI API Key** - GPT-4/GPT-3.5/Embeddings
2. **Solar API Key** - solar-pro/solar-mini
